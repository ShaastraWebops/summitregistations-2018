  ...
  return Participant.create(req.body)
    .then( data => {
      var text_body = '<html><body>Dear Applicant,<br><br>'+
                        ...
                        'For the second round, <b>we request you to send a brief proposal of your idea to <a href="mailto: summitregistrations@shaastra.org">summitregistrations@shaastra.org</a> by <u>15th September, 11:59 p.m.</u></b><br><br>'+
